...
class SignupOtpVerificationScreen extends StatefulWidget {
  ...
  SignupOtpVerificationScreen({required this.mobileNumber});

  @override
  _OTPVerificationScreenState createState() => _OTPVerificationScreenState();
}

class _OTPVerificationScreenState extends State<SignupOtpVerificationScreen> {
        ...
        if (responseBody['status'].toString().toUpperCase() == 'OK') {
          Future.delayed(Duration(milliseconds: 500), () {
            Navigator.pushReplacement(
              context,
              MaterialPageRoute(
                builder: (context) => SetPinScreen(mobileNumber: widget.mobileNumber),
              ),
            );
          });
        } else {
  ...
  Future<void> resendOTP() async {
    ...
    final String resendUrl =
        "https://bportal.bijlipay.co.in:9027/auth/otp/signup/send-otp?mblNo=${widget.mobileNumber}";
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      PinCodeTextField(
                        ...
                        obscureText: false,
                        textStyle: TextStyle(fontSize: screenWidth * 0.045, fontWeight: FontWeight.bold),
